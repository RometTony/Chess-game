...
var dbOptions =
    new DbContextOptionsBuilder<AppDbContext>()
        ...
        .UseSqlite("Data Source=C:/Users/kasutaja/OneDrive/Töölaud/icd0008-2022f-main/CheckersGame/identifier.sqlite")
        .Options;
...
void NewGame()
{
    ...
    string[] options = { "Select saved game", "Show saved options", "Create custom game", "Switch saving option", "Back" };
...
{ 
    ...
    else
    {
        ...
        Console.WriteLine("Choose ai or player: ");
        status.Player1Type = Console.ReadLine() == "ai" ? EPlayerType.Ai : EPlayerType.Human;

        Console.WriteLine("Enter Player2 name: ");
        status.Player2Name = Console.ReadLine()!;
        Console.WriteLine("Choose ai or player: ");
        status.Player2Type = Console.ReadLine() == "ai" ? EPlayerType.Ai : EPlayerType.Human;
    ...
    //game runs until there are opponent buttons
    while (gameState)
    {
...
void SaveCurrentGame()
{
   ...
   else if (repo == repoFs)
   {
       Console.Write("Save name: ");
       var fileName = Console.ReadLine()??"noname";
       Debug.Assert(gameOptions != null, nameof(gameOptions) + " != null");
